...
public class TokenRedis {
    ...
    public static void tokenToRedis(ValueOperations<String, String> redis, String token, String id, String avatar) {
        ...
        redis.set(token, id, 7 * 24 * 60 * 60, TimeUnit.SECONDS);
        redis.set(id, token, 7 * 24 * 60 * 60, TimeUnit.SECONDS);
